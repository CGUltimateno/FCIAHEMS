...
public class mainmenucont {
    ...
    public void handleForgotPassword() throws IOException, LineUnavailableException, UnsupportedAudioFileException {
    ...
    public void goToAdminSignIn() throws IOException {
        ...
        Font.loadFont(getClass().getResourceAsStream("Fonts/Alifiyah.otf"), 10);
        Font.loadFont(getClass().getResourceAsStream("Fonts/Honeymoon Avenue Script Demo.ttf"), 10);
        Font.loadFont(getClass().getResourceAsStream("Fonts/LovelineGlamour.ttf"), 10);
    ...
    public void gotoSPSignIn() throws IOException {
        ...
        Font.loadFont(getClass().getResourceAsStream("Fonts/Alifiyah.otf"), 10);
        Font.loadFont(getClass().getResourceAsStream("Fonts/Honeymoon Avenue Script Demo.ttf"), 10);
        Font.loadFont(getClass().getResourceAsStream("Fonts/Loveline Glamour.ttf"), 10);
    ...
    public void handleAboutButton() throws UnsupportedAudioFileException, IOException, LineUnavailableException {
        popup("About Us", """
                We are a team of highly qualified individuals who started this project at the beginning of December and thanks to Almighty Allah, We are here now. We deal in all kinds of events and try to provide the best services possible.
    ...
    public void handlePrivacyButton() throws UnsupportedAudioFileException, IOException, LineUnavailableException {
