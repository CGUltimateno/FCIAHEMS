...
public class sp_view_approved extends mgr_view_events_Controller {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        ArrayList<Event> EventList = event.getListOfApprovedEvents();
    ...
    public void handleApproveButton() throws IOException, LineUnavailableException, UnsupportedAudioFileException {
        ...
        SPDB sp = new SPDB();
        sp.verifyEvent(eventID);

        // send email to customer
        Event event = new Event();
        String custEmail = event.getCustomerEmailByEventID(eventID);

        emailClass.sendEmail("Event date Approved", "Congratulations! The event date you booked has been verified.", custEmail);
    ...
    public void goToSPMenu() throws IOException {
        System.out.println("Loading SP menu window");
